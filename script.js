...
const news = [
  ...
  {
    id: "news-2",
    image: "https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Gemini_SS.width-1300.jpg",
  ...
  },
  {
    id: "news-3",
    image:
      "https://images.samsung.com/is/image/samsung/p6pim/vn/mz-v9p2t0bw/gallery/vn-990-pro-with-heatsink-mz-v9p2t0cw-535660227?$650_519_PNG$",
  ...
  },
  {
    id: "news-4",
    image:
      "https://news.mit.edu/sites/default/files/styles/news_article__image_gallery/public/images/202401/MIT_Charging-Strategy-01-press_0.jpg",
  ...
  {
    id: "news-5",
    image: "https://viettelstore.vn/tin-tuc/wp-content/uploads/2024/03/5g-viettel.jpg",
  ...
  {
    id: "news-6",
    image: "https://www.tp-link.com/res/images/news/2024/20240108_WiFi7_launch_1.jpg",
  ...
  },
  {
    id: "news-7",
    image:
      "https://www.intel.com/content/dam/www/central-libraries/us/en/images/2023-12/core-ultra-angle-rwd.png.rendition.intel.web.480.270.png",
  ...
  },
  {
    id: "news-8",
    image:
      "https://www.amd.com/content/dam/amd/en/images/products/processors/ryzen/2505503-amd-ryzen-9-702702702702702702-702702702-702702702702702702702702-702702.jpg",
  ...
  {
    id: "news-10",
    image: "https://www.lg.com/content/dam/channel/wcms/vn/images/man-hinh/27gn950-b_aas_evnb_vn_c/gallery/D-01.jpg",
  ...
  },
  {
    id: "news-12",
    image:
      "https://images.samsung.com/is/image/samsung/p6pim/vn/2501/gallery/vn-galaxy-s25-s938-sm-s938bzadeue-thumb-544698175",
  ...
  },
  {
    id: "news-13",
    image:
      "https://assets.corsair.com/image/upload/c_pad,q_auto,h_1024,w_1024,f_auto/products/Gaming-Keyboards/CH-913A01U-NA/Gallery/K100_AIR_WIRELESS_01.webp",
  ...
  },
  {
    id: "news-14",
    image:
      "https://resource.logitechg.com/w_692,c_limit,q_auto,f_auto,dpr_1.0/d_transparent.gif/content/dam/gaming/en/products/pro-x-superlight-2/gallery/pro-x-superlight-2-gallery-1-black.png",
  ...
  },
  {
    id: "news-15",
    image:
      "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/airpods-pro-2-hero-select-202409?wid=976&hei=916&fmt=jpeg&qlt=90&.v=1725492495922",
...
const blog = [
  ...
  },
  {
    ...
    fullContent: `
      ...
      <h3>6. Không cài đặt ứng dụng từ nguồn không xác định</h3>
      <p>Chỉ cài đặt từ App Store, Google Play hoặc các nguồn chính thức.</p>
      
      <h3>7. Sao lưu dữ liệu thường xuyên</h3>
      <p>Sao lưu tất cả dữ liệu quan trọng vào đám mây hoặc ổ cứng ngoài.</p>
      
      <h3>8. Tắt Bluetooth khi không cần thiết</h3>
      <p>Bluetooth có thể bị lợi dụng bởi những kẻ xấu gần đó.</p>
      
      <h3>9. Kiểm tra quyền truy cập ứng dụng</h3>
      <p>Xem xét những quyền mà ứng dụng yêu cầu trước khi cài đặt.</p>
      
      <h3>10. Sử dụng trình quản lý mật khẩu</h3>
      <p>Dùng trình quản lý mật khẩu như 1Password hoặc Bitwarden.</p>
    `,
  },
  {
    id: "blog-4",
    ...
    fullContent: `
      ...
      <h3>Cài đặt GPU</h3>
      <ul>
        <li>NVIDIA: Tăng Power Limit trong NVIDIA Control Panel</li>
        <li>AMD: Sử dụng Radeon Settings để overclock</li>
        <li>Giảm độ phân giải nếu cần thiết</li>
      </ul>
      
      <h3>Quản lý RAM</h3>
      <ul>
        <li>Đóng các ứng dụng lớn không cần thiết</li>
        <li>Cài đặt đủ RAM (16GB tối thiểu, 32GB tốt hơn)</li>
        <li>Kiểm tra tốc độ RAM, nên là 3600MHz+</li>
      </ul>
      
      <h3>Cài đặt Game</h3>
      <ul>
        <li>Giảm độ phân giải từ 4K xuống 1440p hoặc 1080p</li>
        <li>Tắt Ray Tracing nếu muốn FPS cao hơn</li>
        <li>Giảm texture quality nếu cần</li>
      </ul>
    `,
  },
  {
    ...
    fullContent: `
      ...
      <ul>
        ...
        <li>Case & Cooling: 3 triệu</li>
        <li>Monitor: 1440p 144Hz (1.5 triệu)</li>
      </ul>
      
      <h3>Các bước lắp ráp</h3>
      <ol>
        <li>Chuẩn bị workstation sạch sẽ</li>
        <li>Lắp đặt CPU vào socket</li>
        <li>Lắp cooler CPU</li>
        <li>Cài RAM vào slot</li>
        <li>Lắp SSD vào M.2 slot</li>
        <li>Cài GPU vào slot PCIe x16</li>
        <li>Kết nối dây Power</li>
        <li>Kiểm tra và khởi động</li>
      </ol>
    `,
  },
  {
    ...
    fullContent: `
      ...
      <ul>
        <li>Tạo database, bảng tính, kanban</li>
        <li>Đồng bộ trên tất cả thiết bị</li>
        <li>Miễn phí với các tính năng cơ bản</li>
      </ul>
      ...
      <h3>4. Spotify - Streaming nhạc</h3>
      <p>Nghe nhạc không giới hạn với Spotify trên thiết bị di động.</p>
      
      <h3>5. Arc Browser - Trình duyệt mới</h3>
      <p>Trình duyệt Arc là một thay đổi lớn trong cách ta duyệt web.</p>
    `,
  },
  {
    id: "blog-7",
...
function updateAuthUI() {
  ...
  if (currentUser) {
    userInfo.innerHTML = `<span>Xin chào, ${currentUser.username}</span>`
    authBtn.textContent = "Đăng xuất"
    authBtn.className = "btn btn-outline btn-logout"
    authBtn.onclick = logout
  } else {
    userInfo.innerHTML = ""
    authBtn.textContent = "Đăng nhập"
    authBtn.className = "btn btn-primary btn-login"
